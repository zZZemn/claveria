...
<form id="frmSignin" class="sign-in-main-container card container mt-5 mb-5">
    ...
    <div class="si-f-row mt-2">
        <div class="input-container">
            ...
            <input type="text" id="sName" name="username" class="form-control" required>
    ...
    <div class="si-fi-row mt-2">
        <div class="input-container">
            <label for="sValidId">Valid ID</label>
            <input type="file" id="sValidId" name="address" class="form-control" required>
