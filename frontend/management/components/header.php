...
<body>
    ...
    <aside class="side-bar">
        <ul>
            ...
            <li><a href="sales.php" id="nav-sales"><i class="bi bi-currency-dollar"></i> Sales</a></li>
            ...
            <li><a href="inspector.php" id="nav-inspector"><i class="bi bi-receipt"></i> Inspector</a></li>
        </ul>
    </aside>
    <main class="p-3">